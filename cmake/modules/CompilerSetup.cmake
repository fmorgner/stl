...
# Set additional C++ compiler flags when doing a minimum size release build with GCC
if(${CMAKE_CXX_COMPILER_ID} MATCHES "GNU")
  set(
    CMAKE_CXX_FLAGS_MINSIZEREL "-ffunction-sections -fdata-sections -Wl,--gc-sections"
    )
endif()

# Export additional C++ compiler flags for minimum size release builds
set(
  CMAKE_CXX_FLAGS_MINSIZEREL "${CMAKE_CXX_FLAGS_MINSIZEREL} -O2 -DNDEBUG -flto -fvisibility=hidden"
